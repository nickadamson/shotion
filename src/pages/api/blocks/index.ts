...
export default async function handle(req: NextApiRequest, res: NextApiResponse<Block | Block[] | Err>) {
...
// POST /api/blocks
async function handlePOST({ blockData, res }: { blockData: Block; res: NextApiResponse<Block | Err> }) {
    try {
