...
export default async function handle(req: NextApiRequest, res: NextApiResponse<View | View[] | Err>) {
...
// POST /api/views
async function handlePOST({ viewData, res }: { viewData: View; res: NextApiResponse<View | Err> }) {
    try {
