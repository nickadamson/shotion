...
export default async function handle(req: NextApiRequest, res: NextApiResponse<Database | Database[] | Err>) {
...
// POST /api/databases
async function handlePOST({ databaseData, res }: { databaseData: Database; res: NextApiResponse<Database | Err> }) {
    try {
